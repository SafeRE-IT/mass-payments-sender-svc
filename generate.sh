...
GENERATED="${GOPATH}/src/github.com/SafeRE-IT/mass-payments-sender-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/SafeRE-IT/mass-payments-sender-svc/docs/web_deploy"
