...
GENERATED="${GOPATH}/src/gitlab.com/tokend/mass-payments-sender-svc/resources"
OPENAPI_DIR="${GOPATH}/src/gitlab.com/tokend/mass-payments-sender-svc/docs/web_deploy"
